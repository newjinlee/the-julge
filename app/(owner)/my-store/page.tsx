export default function Page() {
  return (
    <div className="relative max-w-[964px] h-full mx-auto px-0 md:py-[60px] md:px-5 sm:py-[60px] sm:px-[12px]">
      ...
      <div className="w-full lg:max-w-[965px] md:w-full sm:w-full h-[217px] flex flex-col items-center justify-center gap-6 border border-gray-300 rounded-lg lg:px-8 md:px-0">
        ...
        <div className="bg-red-500 text-white border rounded-md lg:px-[137px] md:px-[137px] sm:px-5 lg:py-3 md:py-3 sm:py-2">
