...
type ProfileCardProps = { name: string; phoneNumber: string; preferAddress: string; selfIntroduction: string };

export default function ProfileCard({ name, phoneNumber, preferAddress, selfIntroduction }: ProfileCardProps) {
  return (
    <div className="sm:w-full lg:w-[665px] lg:h-[256px] lg:p-[32px] lg:text-[16px] text-[14px]  h-[196px] p-[20px] bg-[#FFEBE7] rounded-xl flex ] justify-between">
      <div className="flex flex-col lg:gap-[12px] gap-[8px]">
        ...
        <h1 className="my-[10px]">{selfIntroduction}</h1>
      </div>
